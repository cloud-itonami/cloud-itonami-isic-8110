# Business Model: Combined Facilities Support Activities
...
## Classification
- Repository: `cloud-itonami-isic-8110` ([github.com/cloud-itonami/cloud-itonami-isic-8110](https://github.com/cloud-itonami/cloud-itonami-isic-8110))
- ISIC Rev.5: `8110` — Combined Facilities Support Activities
- Domain: `:business-support/facilities`
- Social impact: :workplace-safety :service-transparency :labor-coordination
- Actor: `:facilities-support-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :business-support/facilities — who wants
a governed execution scaffold they own instead of renting a closed SaaS.

## Offer
The actor coordinates the :intake :advise :govern :approve :commit :audit pipeline behind an independent Governor: the
...
Capability stack (required): :robotics :identity :forms :dmn :bpmn :audit-ledger :labor.
...
One managed tenant (:business-support/facilities):
...
- Do not bypass the `:facilities-support-governor` for production decisions.
